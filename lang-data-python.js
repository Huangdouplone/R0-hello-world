...
window.LANG_DATA.py = {
  ...
  phases: [
    ...
    {icon:"🧱",name:"第二篇 · 核心数据结构",range:[3,5],desc:"五件套容器、函数与作用域、模块与标准库——写出像样的脚本",wk:4},
    {icon:"⚙️",name:"第三篇 · 工程能力",range:[6,7],desc:"文件与异常、面向对象——能交付结构清楚的小工具",wk:4},
    {icon:"🚀",name:"第四篇 · 深入与实战",range:[8,9],desc:"迭代器与生成器、并发、测试与运行时机制",wk:6}
  ],
  stages: PY_STAGES
};
